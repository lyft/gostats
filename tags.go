...
func (t tagSet) CompareAndSwap(i, j int) {
	if t[i].key > t[j].key {
		t.Swap(i, j)
	}
}
...
func (t tagSet) Sort() {
	...
	case 0, 1:
		return
	case 2:
		t.CompareAndSwap(0, 1)
	case 3:
		t.CompareAndSwap(1, 2)
		t.CompareAndSwap(0, 2)
		t.CompareAndSwap(0, 1)
	case 4:
		t.CompareAndSwap(0, 1)
		t.CompareAndSwap(2, 3)
		t.CompareAndSwap(0, 2)
		t.CompareAndSwap(1, 3)
		t.CompareAndSwap(1, 2)
	case 5:
		t.CompareAndSwap(0, 1)
		t.CompareAndSwap(3, 4)
		t.CompareAndSwap(2, 4)
		t.CompareAndSwap(2, 3)
		t.CompareAndSwap(0, 3)
		t.CompareAndSwap(0, 2)
		t.CompareAndSwap(1, 4)
		t.CompareAndSwap(1, 3)
		t.CompareAndSwap(1, 2)
	case 6:
		t.CompareAndSwap(1, 2)
		t.CompareAndSwap(0, 2)
		t.CompareAndSwap(0, 1)
		t.CompareAndSwap(4, 5)
		t.CompareAndSwap(3, 5)
		t.CompareAndSwap(3, 4)
		t.CompareAndSwap(0, 3)
		t.CompareAndSwap(1, 4)
		t.CompareAndSwap(2, 5)
		t.CompareAndSwap(2, 4)
		t.CompareAndSwap(1, 3)
		t.CompareAndSwap(2, 3)
	case 7:
		...
		t.CompareAndSwap(0, 1)
		t.CompareAndSwap(3, 4)
		t.CompareAndSwap(5, 6)
		t.CompareAndSwap(3, 5)
		t.CompareAndSwap(4, 6)
		t.CompareAndSwap(4, 5)
		t.CompareAndSwap(0, 4)
		t.CompareAndSwap(0, 3)
		t.CompareAndSwap(1, 5)
		t.CompareAndSwap(2, 6)
		t.CompareAndSwap(2, 5)
		t.CompareAndSwap(1, 3)
		t.CompareAndSwap(2, 4)
		t.CompareAndSwap(2, 3)
	case 8:
		...
		t.CompareAndSwap(1, 2)
		t.CompareAndSwap(4, 5)
		t.CompareAndSwap(6, 7)
		t.CompareAndSwap(4, 6)
		t.CompareAndSwap(5, 7)
		t.CompareAndSwap(5, 6)
		t.CompareAndSwap(0, 4)
		t.CompareAndSwap(1, 5)
		t.CompareAndSwap(1, 4)
		t.CompareAndSwap(2, 6)
		t.CompareAndSwap(3, 7)
		t.CompareAndSwap(3, 6)
		t.CompareAndSwap(2, 4)
		t.CompareAndSwap(3, 5)
		t.CompareAndSwap(3, 4)
	default:
